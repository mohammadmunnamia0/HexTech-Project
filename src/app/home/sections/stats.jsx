...
const Stats = () => {
  return (
    <section className="relative overflow-hidden lg:mt-32 mt-10 ">
      <div className="absolute h-72 w-72 scale-125 -right-8 -bottom-10 hidden lg:block">
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 hover:shadow-lg">
        ...
        <div className="mx-auto mt-20 grid max-w-screen-lg grid-cols-1 gap-x-8 gap-y-12 text-center sm:text-left md:grid-cols-3">
          <div className="backdrop-blur-lg relative mb-3 rounded-3xl border bg-white/70 px-12 py-10 text-left shadow transition-shadow duration-300 hover:shadow-2xl lg:px-12">
