...
const slides = [
  {
    ...
    background: 'https://www.smallbusiness.nsw.gov.au/sites/default/files/styles/1280/public/2023-07/iStock-1492719618.jpg?itok=T1vG28Cx',
  },
  {
    title: 'Innovation Meets Design',
    subtitle: "Building tomorrow's digital experiences today.",
    background: 'https://www.wework.com/ideas/wp-content/uploads/sites/4/2017/06/Web_150DPI-20190927_10th_Floor_Conference_Room_2_v1.jpg?fit=1120%2C630',
  },
  {
    title: 'Elevating Your Vision',
    subtitle: 'Where creativity meets technical expertise.',
    background: 'https://cdn.mos.cms.futurecdn.net/D4YBMfcEsNT7BhaNJJgm2A-1200-80.jpg',
  }
];
      ...
      >
        {slides.map((slide, index) => (
          <SwiperSlide key={index} className="relative w-full h-full">
            ...
            <div
              className="absolute inset-0 w-full h-full bg-cover bg-center transition-all duration-[1.5s] scale-110 group-[.swiper-slide-active]:scale-100"
            ...
            <div className="relative h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="opacity-0 translate-y-8 animate-[slideUp_1s_ease-out_0.9s_forwards] space-y-4 sm:space-y-0 sm:space-x-4">
                  <a href="/about" class="relative inline-flex items-center justify-center px-8 overflow-hidden  font-medium  text-white bg-gray-800  group min-w-[200px]">
                  ...
                  <a href="/HireUS" class="relative px-8 py-4 overflow-hidden font-medium text-gray-600 bg-gray-100  border-gray-100  shadow-inner group min-w-[200px]">
