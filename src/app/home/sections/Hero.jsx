      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4">
            <a href="#_" class="px-5 py-2.5 relative rounded group overflow-hidden font-medium bg-purple-50 text-black inline-block">
              ...
              <span class="relative group-hover:text-white">Contact Us</span>
            </a>
