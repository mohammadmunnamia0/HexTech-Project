                            ...
                            >
                                ...
                                <div className="relative z-10 flex items-center justify-between transition-all duration-500 ease-in-out group-hover:opacity-0 group-hover:pointer-events-none h-full">
                                    <div className="w-full">
                                        ...
                                        <Image className="mt-10 h-16 w-16" src={service.icon} alt={service.title} unoptimized />
                                    </div>
                                </div>


                                {/* The bigger card (hidden by default, shown on hover) */}
                                <div className="absolute inset-0 z-20 flex items-center text-white lg:p-8 p-4 bg-Custom_bg transform translate-y-full group-hover:translate-y-0 transition-all duration-700 ease-in-out">
                                    <div className="w-full">
